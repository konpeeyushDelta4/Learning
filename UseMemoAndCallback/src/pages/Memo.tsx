...
import { isEvenMemo } from "../utils/ExpensiveCalculation";
...
const Memo = () => {
  ...
  const MemoizedValue = useMemo<boolean>(() => isEvenMemo(counterOne),[counterOne],);
        ...
        <div className="bg-gradient-to-br from-green-50 to-emerald-100 p-6 rounded-lg shadow-md border border-green-200">
          ...
          <div className="mt-6 p-3 bg-white bg-opacity-70 rounded-lg">
            <p className="text-center font-medium">
              ...
              <span className={`font-bold ${MemoizedValue ? "text-indigo-600" : "text-pink-600"}`}>{MemoizedValue ? "Even ✓" : "Odd ✗"}</span>
            </p>
          </div>
        </div>
