...
const Suggestions: React.FC<SuggestionsProps> = ({
    ...
    if (filteredSuggestions.length === 0) {
        return (
            <div className="suggestions-empty p-4 text-center text-gray-500">
    ...
    return (
        <div className="suggestions-container w-full">
            {Object.entries(groupedSuggestions).map(([category, items]) => (
                <div key={category} className="suggestion-category">
                    <div className="px-3 py-1.5 bg-gray-50 text-xs font-medium text-gray-700 uppercase tracking-wider">
                        {category}
                    </div>
